    ...
    if (secondAnswer === 'follow it') {
        ...
        if (secondAnswer === 'Continue') {
            ...
            if(secondAnswer === 'ladder') {
                ...
                let secondAnswer = window.alert('After ascending the staircase, you discover a shiny blue stone, which you take home and cherish forever.')
            }
...
if (secondAnswer === 'past the dragon') {
    ...
    if(secondAnswer === 'stay') {
        ...
        let secondAnswer = window.alert('Quickly, you run back to the caves entrance. Sheepish, you return home.')
    }
